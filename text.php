...
$textbotlang['users']['changelocation'] = [
    'title' => 'تغییر لوکیشن',
    'select_panel' => 'لطفاً لوکیشن جدید را انتخاب کنید:',
    'success' => 'لوکیشن سرویس %s به %s تغییر یافت.'
];
$textbotlang['users']['error'] = [
    'invalid_service' => 'سرویس معتبر نیست.',
    'no_panels_available' => 'هیچ لوکیشن فعالی در دسترس نیست.',
    'invalid_panel' => 'لوکیشن انتخاب‌شده معتبر نیست.',
    'user_not_found' => 'کاربر در پنل فعلی یافت نشد.',
    'change_failed' => 'تغییر لوکیشن ناموفق بود. لطفاً بعداً تلاش کنید.',
    'panel_full_or_invalid' => 'ظرفیت سرور انتخاب‌شده پر شده یا نامعتبر است. لطفاً سرور دیگری انتخاب کنید.'
];
$textbotlang['Admin']['Report']['location_changed'] = 'لوکیشن سرویس %s از %s به %s تغییر یافت.';
